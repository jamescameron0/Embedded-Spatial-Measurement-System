...
void SysTick_Wait10ms(uint32_t delay){
  uint32_t i;
  for(i=0; i<delay; i++){
    SysTick_Wait(140000);  // wait 10ms if clock is 14MHz, period = 1/14,000,000 = 
  }													// 7.1x10^-8 s, 10 ms / 7.1x10^-8 = 140,000
}
void SysTick_Wait1ms(uint32_t delay){
  uint32_t i;
  for(i=0; i<delay; i++){
    SysTick_Wait(14000);  // wait 10ms if clock is 14MHz, period = 1/14,000,000 = 
  }													// 7.1x10^-8 s, 10 ms / 7.1x10^-8 = 140,000
}
